...
const internships = [
  {
    ...
    Subtitle: "3-6 months",
    desc: "Understant the Era of Frontend Web Development with live project-based training using modern tech stacks.",
  },
      ...
      <section className="relative min-h-screen overflow-hidden px-6 md:px-16 py-24 text-gray-900 dark:text-white transition-colors duration-500">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            {internships.map((item, i) => (
              <motion.div
                ...
                className="group relative overflow-hidden rounded-3xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5 backdrop-blur-xl p-12">
                ...
                <div className="relative">
                  ...
                  <p className="inline-block mt-3 rounded-full bg-cyan-500/10 px-4 py-1 text-sm font-medium text-cyan-500">
                    {item.Subtitle}
                  </p>
          ...
          >
            ...
            <p className="mt-5 text-center text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Gain practical experience, industry exposure, and professional
              mentorship while working on real-world software projects.
            </p>
              ...
              {[
                ...
                return (
                  ...
                  >
                    ...
                    <Icon
                      size={42}
                      className="mx-auto text-cyan-500 mb-6"
                    />
          ...
          <motion.section
            ...
            <p className="mt-5 text-center text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Our internship programs are designed for students and fresh graduates
              who are passionate about building a career in software development.
            </p>
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="mt-5 max-w-3xl mx-auto text-gray-600 dark:text-gray-300">
                Our internship journey is structured to help you learn,
                build, and grow with real industry experience.
              </p>
          ...
          >
            ...
            <div className="rounded-3xl border border-gray-200 dark:border-white/10 bg-gradient-to-r from-blue-600 to-cyan-500 p-10 md:p-16 text-center shadow-xl">
              ...
              <div className="mt-10 flex flex-wrap justify-center gap-5">
                ...
                <Link
                  href="/contact"
                  className="rounded-full bg-white px-8 py-4 font-semibold text-blue-700 hover:scale-105 transition duration-300"
                >
