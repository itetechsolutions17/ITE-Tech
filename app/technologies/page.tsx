...
function GlowCard({ title, desc, icon: Icon, }: {
  title: string;
  desc: string;
  icon: LucideIcon;
}) {
    ...
    <PageWrapper>
      <div className="bg-white dark:bg-[#0b1120] text-gray-900 dark:text-gray-200 transition-colors duration-500 min-h-screen px-6 md:px-16 py-24">
        ...
        <section className="text-center mb-16">
          <h1 className="text-4xl font-bold mb-4">Technologies We Use
            To Build Modern Software</h1>
          <p className="max-w-2xl mx-auto text-gray-600 dark:text-gray-300">
            ITE Tech Solutions leverages modern,
        ...
        {/* FRONTEND */}
        <Section title="Frontend Development" icon={Monitor} items={[
        ...
        {/* BACKEND */}
        <Section title="Backend Development" icon={Server} items={[
        ...
        {/* FRAMEWORKS */}
        <Section title="Frameworks & Libraries" icon={Boxes} items={[
        ...
        {/* DATABASE */}
        <Section title="Databases" icon={Database} items={[
        ...
        {/* CLOUD */}
        <Section title="Cloud & DevOps" icon={Cloud} items={[
        ...
        {/* TOOLS */}
        <Section title="Developer Tools" icon={Hammer} items={[
