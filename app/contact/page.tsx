        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="text-center mb-20" >
            ...
            <p className="mt-8 text-gray-600 dark:text-gray-300 max-w-4xl mx-auto text-xl leading-10" >
              ...
              Whether you're planning a website, mobile application,
              enterprise software, AI solution, cloud infrastructure,
              or cybersecurity services, our experts are ready to help
            ...
            <motion.div
                ...
                <div className="space-y-5">
                  ...
                  <div className="rounded-2xl border bg-gray-50 dark:bg-white/5 border-gray-200 dark:border-white/10 backdrop-blur-lg p-5 hover:border-cyan-400/30 transition">
                    ...
                    <a
                      ...
                      className="mt-2 block text-gray-900 dark:text-white hover:text-cyan-400 transition"
                    >
                  ...
                  <div className="rounded-2xl border bg-gray-50 dark:bg-white/5 border-gray-200 dark:border-white/10 backdrop-blur-lg p-5 hover:border-cyan-400/30 transition">
                    ...
                    <p className="mt-2 text-gray-600 dark:text-gray-300 leading-8">

                      ITE Tech Solutions<br />

                      Harikrishna Complex, First Floor<br />

                      Main Road, Samarth Nagar,<br />
              ...
              <div className="overflow-hidden rounded-3xl border border-gray-200 dark:border-white/10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6 px-4">
                  ...
                  <a
                    ...
                    className="flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-blue-600 to-cyan-500 py-4 text-white font-semibold hover:scale-105 transition duration-300 shadow-lg"
                  >
                    <MapPinned size={20} />
                    Get Directions
                  </a>
                  ...
                  <a
                    href="tel:+919607522007"
                    className="flex items-center justify-center gap-2 rounded-2xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5 backdrop-blur-xl py-4 text-gray-900 dark:text-white font-semibold hover:border-cyan-400/30 hover:bg-white/10 hover:scale-105 transition-all duration-300">
                    <PhoneCall size={20} />
                    Call Now
                  </a>
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  ...
                  <div className="flex items-start gap-4 rounded-2xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5 p-5 hover:border-cyan-400/30 transition duration-300">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 text-sm mt-1 leading-6">
                        We aim to respond to all business inquiries within 24 business hours.
                      </p>
                    </div>
                  ...
                  <div className="flex items-start gap-4 rounded-2xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5 p-5 hover:border-cyan-400/30 transition duration-300">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 text-sm mt-1 leading-6">
                        Every solution is designed to support your business goals and long-term growth.
                      </p>
                    </div>
                  ...
                  <div className="flex items-start gap-4 rounded-2xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5 p-5 hover:border-cyan-400/30 transition duration-300">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 text-sm mt-1 leading-6">
                        From planning to deployment, our team is here to support you at every stage.
                      </p>
                    </div>
              ...
              <div className="flex gap-6 justify-center">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-600 dark:text-gray-300 hover:text-gray-500 transition duration-300 hover:scale-110"
                >
                  <FaGithub size={28} />
                </a>
              </div>
              ...
              {/* Response Time */}
              <div className="rounded-2xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5 backdrop-blur-xl p-6">

                <h3 className="text-xl font-bold text-cyan-500 dark:text-cyan-400 text-center mb-5">
                  Our Commitment
                </h3>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    <Clock3 className="text-cyan-500" size={20} />
                    <span className="text-gray-700 dark:text-gray-300">
                  ...
                  <div className="flex items-center gap-3">
                    <Headset className="text-cyan-500" size={20} />
                    <span className="text-gray-700 dark:text-gray-300">
