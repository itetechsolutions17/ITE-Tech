        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="text-center mb-20" >
            ...
            <p className="mt-8 text-gray-300 max-w-4xl mx-auto text-xl leading-10">
              Have a project in mind? Need internship collaboration? Get in touch with ITE Tech Solutions today.
            </p>
          </motion.div>
          {/* Contact Grid */}
          <div className="grid lg:grid-cols-2 gap-10 items-start">
            {/* FORM */}
            <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }} className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl p-10" >
              {/* Glow */}
              ...
              <div className="relative">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <textarea rows={6} placeholder="Tell us about your project..." required
                    ...
                    className="w-full rounded-2xl border border-white/10 bg-white/5 px-5 py-4 text-white placeholder:text-gray-400 focus:border-cyan-400 focus:outline-none" />
                  <button type="submit" className="w-full rounded-2xl bg-gradient-to-r from-blue-600 to-cyan-500 py-4 text-lg font-semibold hover:scale-[1.02] transition duration-300" >
                    Send Message
                  </button>
                </form>
              </div>
